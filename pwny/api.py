...
PIPE_READALL = tlv_custom_tag(API_CALL_INTERNAL, PIPE_BASE, API_CALL + 1)
PIPE_WRITE = tlv_custom_tag(API_CALL_INTERNAL, PIPE_BASE, API_CALL + 2)
PIPE_SEEK = tlv_custom_tag(API_CALL_INTERNAL, PIPE_BASE, API_CALL + 3)
PIPE_TELL = tlv_custom_tag(API_CALL_INTERNAL, PIPE_BASE, API_CALL + 4)
PIPE_CREATE = tlv_custom_tag(API_CALL_INTERNAL, PIPE_BASE, API_CALL + 5)
PIPE_DESTROY = tlv_custom_tag(API_CALL_INTERNAL, PIPE_BASE, API_CALL + 6)
PIPE_HEARTBEAT = tlv_custom_tag(API_CALL_INTERNAL, PIPE_BASE, API_CALL + 7)
...
BUILTIN_UNSECURE = tlv_custom_tag(API_CALL_STATIC, BUILTIN_BASE, API_CALL + 9)
...
PROCESS_KILLALL = tlv_custom_tag(API_CALL_STATIC, PROCESS_BASE, API_CALL + 3)

PROCESS_PIPE = tlv_custom_pipe(PIPE_STATIC, PROCESS_BASE, PIPE_TYPE)

FS_BASE = 3

FS_TYPE_MODE = tlv_custom_type(TLV_TYPE_STRING, FS_BASE, API_TYPE)
FS_TYPE_START_DATE = tlv_custom_type(TLV_TYPE_INT, FS_BASE, API_TYPE)
FS_TYPE_END_DATE = tlv_custom_type(TLV_TYPE_INT, FS_BASE, API_TYPE + 1)
...
FS_FIND = tlv_custom_tag(API_CALL_STATIC, FS_BASE, API_CALL + 10)
